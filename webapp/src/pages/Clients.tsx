...
function Clients() {
    ...
    const [deleteModal, setDeleteModal] = useState<{ show: boolean; client: Client | null }>({
        show: false,
        client: null
    });
    ...
    const sortedClients = [...clients]
        ...
        .sort((a, b) => {
            let valA = (a as any)[sortField]?.toLowerCase() || '';
            let valB = (b as any)[sortField]?.toLowerCase() || '';
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            alert('Erreur: Impossible de supprimer un client ayant des interventions liées.');
            setDeleteModal({ show: false, client: null });
        }
    };
    ...
    const exportCSV = () => {
        const headers = ['Nom', 'Sous-lieu', 'Rue', 'Code Postal', 'Ville', 'Contact', 'Téléphone'];
        const rows = sortedClients.map(c => [
            c.nom, c.sousLieu || '', c.rue, c.codePostal, c.ville, c.contact, c.telephone
        ]);
        const csvContent = [
            headers.join(';'),
        ...
        <div className="space-y-6" style={{ color: 'var(--text-primary)' }}>
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)' }}>Gestion de la base client</p>
                </div>
            ...
            <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))' }}>
                <div style={{
                    ...
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>👥 Total clients</div>
                </div>
                <div style={{
                    backgroundColor: 'var(--bg-primary)',
                    padding: '16px',
                    ...
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>🏙️ Villes</div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div className="mb-6 relative" style={{ maxWidth: '400px' }}>
                ...
                <div className="flex items-center gap-4 mb-4 flex-wrap">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontSize: '13px', fontWeight: 500, color: 'var(--text-secondary)' }}>Ville :</span>
                        <select
                            value={cityFilter}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontSize: '13px', fontWeight: 500, color: 'var(--text-secondary)' }}>Trier par :</span>
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '8px',
                                border: '1px solid var(--border-color)',
                                backgroundColor: sortField === 'nom' ? 'var(--primary-color)' : 'var(--bg-secondary)',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '8px',
                                border: '1px solid var(--border-color)',
                                backgroundColor: sortField === 'ville' ? 'var(--primary-color)' : 'var(--bg-secondary)',
                    ...
                    columns={[
                        {
                            ...
                            render: (client) => (
                                <div className="flex flex-col">
                                    ...
                                    {client.sousLieu && <span className="text-xs text-gray-500 mt-1">📍 {client.sousLieu}</span>}
                                </div>
                            )
                        },
                        {
                        ...
                        },
                        {
                            ...
                            render: (client) => (
                                <div className="text-sm text-gray-600">
                                    {client.rue}<br />
                                    {client.codePostal} <span className="uppercase">{client.ville}</span>
                                </div>
                            )
                        }
                    ]}
                ...
                {clients.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 mt-2">Commencez par ajouter un nouveau client à la base de données.</p>
                    </div>
                )}
                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '8px',
                                border: '1px solid var(--border-color)',
                                backgroundColor: currentPage === 1 ? 'var(--bg-secondary)' : 'var(--card-bg)',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '8px',
                                border: '1px solid var(--border-color)',
                                backgroundColor: currentPage === totalPages ? 'var(--bg-secondary)' : 'var(--card-bg)',
